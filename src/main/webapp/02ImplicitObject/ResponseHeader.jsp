...
/*
	...
	날짜가 출력된다. 만약 9시 이전의 시간이 설정되면 어제날짜가 나오게 된다.
*/
...
<body>
    ...
    /*
    첫번째 출력결과에서는 myNumber라는 헤더명이 2번 출력되는데 동일한 값이 출력된다.
    이것은 getHeader()메서드의 특성으로 처음 입력한 헤더값만 출력되게 된다.
    */
    %>
